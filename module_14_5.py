...
kb.row(KeyboardButton(text='Регистрация'))
kb.row(KeyboardButton(text='Рассчитать'), KeyboardButton(text='Купить'), KeyboardButton(text='Информация'))
